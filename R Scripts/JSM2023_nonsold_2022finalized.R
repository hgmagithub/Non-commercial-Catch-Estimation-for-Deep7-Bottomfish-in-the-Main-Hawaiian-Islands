...
observed_catch = read.sas7bdat("i3_ns_add2022f.sas7bdat", debug = TRUE) # _ns for non-sold catch, 19947 records
unavailable_catch = read.sas7bdat("i2_ns_add2022f.sas7bdat", debug = TRUE) # _ns for non-sold, 15963 records
...
setwd("C:/Users/Hongguang.Ma/Documents/Telework/Deep 7 Analyses/Nonsold catch_jsm")
...
write.csv(as.data.frame(year_totalcatch), file="Orig_yearlynonsold.csv")
write.csv(as.data.frame(yearwave_totalcatch_num), file ="unsmoothedwavelynonsold_catch.csv")
write.csv(as.data.frame(yearwave_totalcatch_num_var), file ="variance_bywave.csv")
...
write.csv(cpue_rawdf, file="CPUE_raw_include2022.csv")
write.csv(SmoothedCatch_bywave_dfcompare, file="SmoothedWavelynonsold_include2022impute_modify.csv")
#***The above results are the same as those from the exploration section****
write.csv(SmoothedCatch_dfcompare, file="SmoothedYearlynonsold_forcomparison.csv")
write.csv(unacounted_SH, file="Deep7catch_fromSH.csv")
...
catchnum = read.csv("SmoothedWavelynonsold_2022complete.csv")
df = catchnum[-c(1)]
...
dfwgt$FY = modify$FY
dfwgt$CY = modify$CY
write.csv(dfwgt, file="Smoothedwavelynonsold_cachweight.csv")

origcatch = read.csv("unsmoothedwavelynonsold_catch.csv")
variance = read.csv("variance_bywave.csv")
...
dfvar$FY = modify$FY
dfvar$CY = modify$CY
write.csv(dfvar, file="dataforPSE.csv")
